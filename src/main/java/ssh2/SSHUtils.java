...
//                .username("root")
//                .password("107@yusys.com")
//                .host("192.168.251.107")
//                .port(22)
//                .build();
//        try{
//            ssh.connect();
//            if(ssh.isReady()) {
//                String result = ssh.write("du -b /opt/yusys/jenkins/save//yqitmp/background//dev_background.war");
//                ssh.close();
//                System.out.println(result);
//            }
//        }catch(Exception e){ e.printStackTrace(); }
        boolean b = uploadTo("root","107@yusys.com","192.168.251.107",22,"/opt/temp/1.txt","/opt/temp/","C:\\Users\\djf\\Desktop\\1.txt");
