...
public class SSHUtils {
     ...
     * @return
     */
    public static String executeCommond(ShellConnectionStream ssh,String commond){
        String result = "";
        try{
            ssh.connect();
            if(ssh.isReady()) {
                result = ssh.write(commond);
                ssh.close();
            }
        }catch(Exception e){
            e.printStackTrace();
     ...
     * @return
     */
    public static String executeCommondList(ShellConnectionStream ssh, List<String> shellList){
        String result = "";
        try{
            ssh.connect();
            if(ssh.isReady()) {
                result = ssh.execCommandByShell(shellList);
                ssh.close();
            }
        }catch(Exception e){
            e.printStackTrace();
